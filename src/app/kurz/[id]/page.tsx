  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        >
          <h1 style={{ fontSize: 32, fontWeight: 800, margin: "0 0 8px", fontStyle: "italic", color: "var(--color-text-main)" }}>
            {courseData.courseTitle}
          </h1>
          <p style={{ fontSize: 15, margin: 0, color: "var(--color-text-secondary)" }}>
            Vedoucí kurzu: <strong style={{ color: "var(--color-text-main)" }}>{courseData.instructor}</strong> • {courseData.duration}
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-6 items-start">
          ...
          <div className="lg:col-span-1">
            ...
            >
              ...
              <div style={{ display: "flex", gap: 16, flexWrap: "wrap", paddingTop: 16, borderTop: "1px solid var(--color-border)", marginBottom: 16 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  <div style={{ width: 36, height: 36, borderRadius: 8, background: "#F4F5FA", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <Clock style={{ width: 18, height: 18, color: "var(--color-primary)" }} />
                  </div>
                  <div>
                    <div style={{ fontSize: 11, color: "var(--color-text-secondary)" }}>{t("courseDetail.courseLength")}</div>
                    <div style={{ fontSize: 14, fontWeight: 600, color: "var(--color-text-main)" }}>{courseData.duration}</div>
                  </div>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  <div style={{ width: 36, height: 36, borderRadius: 8, background: "#F4F5FA", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  ...
                  <div>
                    <div style={{ fontSize: 11, color: "var(--color-text-secondary)" }}>{t("courseDetail.activityCount")}</div>
                    <div style={{ fontSize: 14, fontWeight: 600, color: "var(--color-text-main)" }}>{courseData.activitiesCount}</div>
                  </div>
                </div>
              </div>
              ...
              <p style={{ fontSize: 11, color: "var(--color-text-secondary)", margin: "8px 0 0", textAlign: "center" }}>
        ...
        <div className="grid lg:grid-cols-2 gap-6 mb-8">
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
              <div style={{ width: 44, height: 44, borderRadius: 12, background: "rgba(119, 249, 217, 0.25)", display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            <div style={{ display: "flex", alignItems: "baseline", gap: 8, marginBottom: 12 }}>
              <span style={{ fontSize: 32, fontWeight: 800, color: "var(--color-text-main)" }}>{progress}</span>
              <span style={{ fontSize: 15, color: "var(--color-text-secondary)" }}>/ {total} aktivit</span>
              <span style={{ marginLeft: "auto", fontSize: 15, fontWeight: 700, color: "#059669" }}>{progressPercent} %</span>
            </div>
          ...
          >
            <div style={{ display: "flex", gap: 16, alignItems: "flex-start" }}>
              ...
              <div>
                ...
                <p
                  className="text-sm"
                  style={{ color: "#92400E", margin: 0, lineHeight: 1.6 }}
                >
